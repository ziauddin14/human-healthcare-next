  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-center mb-12 md:mb-20 text-slate-900 dark:text-slate-100"
          >
            Here's How We Help
          </motion.h2>
      ...
      <section className="py-20 bg-white dark:bg-gray-950">
        ...
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-8 text-slate-900 dark:text-slate-100">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl mb-10 font-light">
            ...
            <a 
              ...
              className="underline font-bold text-white hover:text-blue-100 transition-all duration-300 ease-in-out decoration-2 underline-offset-4 focus:outline-none focus:ring-2 focus:ring-white/50 rounded"
            >
              0319-2060174
            </a>
          </p>
