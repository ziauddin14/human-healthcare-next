      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-20">
        {[
          ...
          <motion.div
            ...
            className={`bg-white dark:bg-gray-900 p-6 md:p-8 lg:p-10 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 ease-out transform border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600`}
          >
